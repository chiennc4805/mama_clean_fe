...
import { CheckCircleOutlined, ClockCircleOutlined, CloseCircleOutlined, FileAddOutlined, FileDoneOutlined, LoginOutlined, LogoutOutlined, MessageOutlined, StopOutlined, UserAddOutlined } from '@ant-design/icons';
dayjs.locale("vi");
                ...
                <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
                    <Card
                        style={{
                            ...
                            flex: 1, // 👈 giúp Card kéo dài hết chiều cao cột
                            display: "flex",
